...
import Foundation
class dataStoreFavourite {
    
    static let shared =  dataStoreFavourite()
    ...
    func getData( hostURl:String ,path: String, params: [String: String]?, completion: @escaping (Result<favouriteStruct?, Error>) -> Void){
        ...
        urlSession.dataTask(with: request) { (data, response, error) in
            ...
            do {
                ...
                let returnStakeholder = try decoder.decode(favouriteStruct?.self, from: data)
