//
//  dataStoreMarkFavouriteFailed.swift
//  INFO-6131-project
//
//  Created by Anh Dinh Le on 2022-07-13.
//

import Foundation
class dataStoreMarkFavouriteFailed {
    
    static let shared =  dataStoreMarkFavouriteFailed()
