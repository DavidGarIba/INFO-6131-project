...
class dataStorePlayVideo {
    
    static let shared =  dataStorePlayVideo()
    ...
    func getData( hostURl:String ,path: String, params: [String: String]?, completion: @escaping (Result<PlayVideoStruct?, Error>) -> Void){
        ...
        urlSession.dataTask(with: request) { (data, response, error) in
            ...
            do {
                ...
                let returnStakeholder = try decoder.decode(PlayVideoStruct?.self, from: data)
